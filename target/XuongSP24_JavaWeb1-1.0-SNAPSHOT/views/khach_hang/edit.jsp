...
<div class="container-sm">
    ...
    <form action="/khach-hang/update?id=${data.id}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="sdt" value="${data.ten}" type="text">
        </div>
        ...
        <div class="form-group my-2 ">
            ...
            <input class="form-check-input" type="radio" name="trangThai"
                   value="1" ${data.trangThai ==1 ? "checked" : ""}/>Đang hoạt động
            <input class="form-check-input" type="radio" name="trangThai"
                   value="0" ${data.trangThai ==0 ? "checked" : ""}/>Ngừng hoạt động
        </div>
        <div>
